...
while i < 10:
    # incrémentation de 1
    i += 1
    print("loop" + str(i))  #premiere itération à 1 jusqu'à 10

# boucle while classique, de 0 à 9      #les deux sont equivalentes sur le nombre d'itération : 10
i = 0
while i < 10:
    print("loop" + str(i))  #premiere itération à 0 jusqu'a 9
    # incrémentation de 1
    i += 1
