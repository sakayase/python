...
print(f"Il y a {percentage:.0f} % de chance d'avoir deux fois pile avec deux lancers")
...
print(f"Il y a {percentage:.0f} % de chance d'avoir deux fois pile avec trois lancers")
